...
export default function Dashboard() {
    ...
    const profitTemplate = (rowData) => {
        ...
        return (
            <Badge value={`${rowData.eval_profit_rate}%`} 
    ...
    return (
        <div className="p-4 md:p-6 lg:p-8">
            ...
            {selectedAccount && (
                <Card title={`${selectedAccount.alias} - 보유 종목 현황`} className="shadow-4 border-round">
                    <DataTable value={selectedAccount.stocks} 
                        ...
                        <Column field="avg_price" header="매입평단가" body={(rd) => currencyTemplate(rd.avg_price)} sortable></Column>
                        <Column field="current_price" header="현재가" body={(rd) => currencyTemplate(rd.current_price)} sortable></Column>
                        <Column field="eval_profit_rate" header="수익률" body={profitTemplate} sortable></Column>
                    </DataTable>
                </Card>
            )}
        </div>
